...
public abstract class ExternalInvocationTaskValidator extends ProcessLevelValidator {
    ...
    protected void validateFieldDeclarationsForEmail(com.eudemon.flow.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForShell(com.eudemon.flow.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForDmn(com.eudemon.flow.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
    ...
    protected void validateFieldDeclarationsForHttp(com.eudemon.flow.bpmn.model.Process process, TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, List<ValidationError> errors) {
