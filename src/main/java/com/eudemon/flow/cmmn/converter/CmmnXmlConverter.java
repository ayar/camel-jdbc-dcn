...
import com.eudemon.flow.cmmn.converter.export.CaseExport;
import com.eudemon.flow.cmmn.converter.export.CmmnDIExport;
import com.eudemon.flow.cmmn.converter.export.DefinitionsRootExport;
import com.eudemon.flow.cmmn.converter.export.StageExport;
import com.eudemon.flow.cmmn.model.Association;
import com.eudemon.flow.cmmn.model.BaseElement;
import com.eudemon.flow.cmmn.model.Case;
import com.eudemon.flow.cmmn.model.CaseElement;
import com.eudemon.flow.cmmn.model.CmmnDiEdge;
import com.eudemon.flow.cmmn.model.CmmnDiShape;
import com.eudemon.flow.cmmn.model.CmmnModel;
import com.eudemon.flow.cmmn.model.Criterion;
import com.eudemon.flow.cmmn.model.DecisionTask;
import com.eudemon.flow.cmmn.model.HasEntryCriteria;
import com.eudemon.flow.cmmn.model.HasExitCriteria;
import com.eudemon.flow.cmmn.model.PlanFragment;
import com.eudemon.flow.cmmn.model.PlanItem;
import com.eudemon.flow.cmmn.model.PlanItemDefinition;
import com.eudemon.flow.cmmn.model.ProcessTask;
import com.eudemon.flow.cmmn.model.Sentry;
import com.eudemon.flow.cmmn.model.SentryOnPart;
import com.eudemon.flow.cmmn.model.Stage;
import com.eudemon.flow.cmmn.model.Task;
import com.eudemon.flow.cmmn.model.TimerEventListener;
        ...
        for (PlanItem planItem : planFragment.getPlanItems()) {
            ...
            if (planItemDefinition instanceof PlanFragment) {
                ...
                if (processTask.getProcessRef() != null) {
                    com.eudemon.flow.cmmn.model.Process process = cmmnModel.getProcessById(processTask.getProcessRef());
                    if (process != null) {
                ...
                if (decisionTask.getDecisionRef() != null) {
                    com.eudemon.flow.cmmn.model.Decision decision = cmmnModel.getDecisionById(decisionTask.getDecisionRef());
                    if (decision != null) {
