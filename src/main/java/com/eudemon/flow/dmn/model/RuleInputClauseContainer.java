 ...
 */
package com.eudemon.flow.dmn.model;
...
public class RuleInputClauseContainer {
    ...
    public RuleInputClauseContainer(InputClause inputClause, UnaryTests inputEntry) {
    ...
    public void setInputEntry(UnaryTests inputEntry) {
        this.inputEntry = inputEntry;
    }
}
