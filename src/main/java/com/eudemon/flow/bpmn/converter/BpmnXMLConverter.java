 ...
 */
package com.eudemon.flow.bpmn.converter;
...
import com.eudemon.flow.bpmn.converter.alfresco.AlfrescoStartEventXMLConverter;
import com.eudemon.flow.bpmn.converter.alfresco.AlfrescoUserTaskXMLConverter;
import com.eudemon.flow.bpmn.converter.child.DocumentationParser;
import com.eudemon.flow.bpmn.converter.child.IOSpecificationParser;
import com.eudemon.flow.bpmn.converter.child.MultiInstanceParser;
import com.eudemon.flow.bpmn.converter.export.BPMNDIExport;
import com.eudemon.flow.bpmn.converter.export.CollaborationExport;
import com.eudemon.flow.bpmn.converter.export.DataStoreExport;
import com.eudemon.flow.bpmn.converter.export.DefinitionsRootExport;
import com.eudemon.flow.bpmn.converter.export.FlowableListenerExport;
import com.eudemon.flow.bpmn.converter.export.MultiInstanceExport;
import com.eudemon.flow.bpmn.converter.export.ProcessExport;
import com.eudemon.flow.bpmn.converter.export.SignalAndMessageDefinitionExport;
import com.eudemon.flow.bpmn.converter.parser.BpmnEdgeParser;
import com.eudemon.flow.bpmn.converter.parser.BpmnShapeParser;
import com.eudemon.flow.bpmn.converter.parser.DataStoreParser;
import com.eudemon.flow.bpmn.converter.parser.DefinitionsParser;
import com.eudemon.flow.bpmn.converter.parser.ExtensionElementsParser;
import com.eudemon.flow.bpmn.converter.parser.ImportParser;
import com.eudemon.flow.bpmn.converter.parser.InterfaceParser;
import com.eudemon.flow.bpmn.converter.parser.ItemDefinitionParser;
import com.eudemon.flow.bpmn.converter.parser.LaneParser;
import com.eudemon.flow.bpmn.converter.parser.MessageFlowParser;
import com.eudemon.flow.bpmn.converter.parser.MessageParser;
import com.eudemon.flow.bpmn.converter.parser.ParticipantParser;
import com.eudemon.flow.bpmn.converter.parser.PotentialStarterParser;
import com.eudemon.flow.bpmn.converter.parser.ProcessParser;
import com.eudemon.flow.bpmn.converter.parser.ResourceParser;
import com.eudemon.flow.bpmn.converter.parser.SignalParser;
import com.eudemon.flow.bpmn.converter.parser.SubProcessParser;
import com.eudemon.flow.bpmn.converter.util.BpmnXMLUtil;
import com.eudemon.flow.bpmn.exceptions.XMLException;
...
import com.eudemon.flow.bpmn.model.BooleanDataObject;
import com.eudemon.flow.bpmn.model.BoundaryEvent;
import com.eudemon.flow.bpmn.model.BpmnModel;
import com.eudemon.flow.bpmn.model.DateDataObject;
import com.eudemon.flow.bpmn.model.DoubleDataObject;
...
import com.eudemon.flow.bpmn.model.IntegerDataObject;
import com.eudemon.flow.bpmn.model.LongDataObject;
import com.eudemon.flow.bpmn.model.Pool;
import com.eudemon.flow.bpmn.model.Process;
import com.eudemon.flow.bpmn.model.SequenceFlow;
import com.eudemon.flow.bpmn.model.StringDataObject;
import com.eudemon.flow.bpmn.model.SubProcess;
import com.eudemon.flow.bpmn.model.TextAnnotation;
import com.eudemon.flow.bpmn.model.Transaction;
import com.eudemon.flow.common.engine.api.io.InputStreamProvider;
