 ...
 */
package com.eudemon.flow.bpmn.converter.util;
...
import com.eudemon.flow.bpmn.converter.child.BaseChildElementParser;
import com.eudemon.flow.bpmn.converter.child.CancelEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.CompensateEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.ConditionExpressionParser;
import com.eudemon.flow.bpmn.converter.child.DataInputAssociationParser;
import com.eudemon.flow.bpmn.converter.child.DataOutputAssociationParser;
import com.eudemon.flow.bpmn.converter.child.DataStateParser;
import com.eudemon.flow.bpmn.converter.child.DocumentationParser;
import com.eudemon.flow.bpmn.converter.child.ErrorEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.ExecutionListenerParser;
import com.eudemon.flow.bpmn.converter.child.FieldExtensionParser;
import com.eudemon.flow.bpmn.converter.child.FlowNodeRefParser;
import com.eudemon.flow.bpmn.converter.child.FlowableEventListenerParser;
import com.eudemon.flow.bpmn.converter.child.FlowableFailedjobRetryParser;
import com.eudemon.flow.bpmn.converter.child.FlowableHttpRequestHandlerParser;
import com.eudemon.flow.bpmn.converter.child.FlowableHttpResponseHandlerParser;
import com.eudemon.flow.bpmn.converter.child.FlowableMapExceptionParser;
import com.eudemon.flow.bpmn.converter.child.FormPropertyParser;
import com.eudemon.flow.bpmn.converter.child.IOSpecificationParser;
import com.eudemon.flow.bpmn.converter.child.MessageEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.MultiInstanceParser;
import com.eudemon.flow.bpmn.converter.child.SignalEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.TaskListenerParser;
import com.eudemon.flow.bpmn.converter.child.TerminateEventDefinitionParser;
import com.eudemon.flow.bpmn.converter.child.TimeCycleParser;
import com.eudemon.flow.bpmn.converter.child.TimeDateParser;
import com.eudemon.flow.bpmn.converter.child.TimeDurationParser;
import com.eudemon.flow.bpmn.converter.child.TimerEventDefinitionParser;
import com.eudemon.flow.bpmn.model.BaseElement;
import com.eudemon.flow.bpmn.model.BpmnModel;
import com.eudemon.flow.bpmn.model.ExtensionAttribute;
import com.eudemon.flow.bpmn.model.ExtensionElement;
import com.eudemon.flow.bpmn.model.GraphicInfo;
