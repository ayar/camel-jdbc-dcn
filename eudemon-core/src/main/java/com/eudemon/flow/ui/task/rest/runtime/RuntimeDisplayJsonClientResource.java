...
import com.eudemon.flow.bpmn.model.Lane;
...
import com.eudemon.flow.ui.common.service.exception.InternalServerErrorException;
...
import com.eudemon.flow.ui.task.service.debugger.DebuggerService;
import com.eudemon.flow.ui.task.service.editor.mapper.EventInfoMapper;
import com.eudemon.flow.ui.task.service.editor.mapper.InfoMapper;
import com.eudemon.flow.ui.task.service.editor.mapper.ReceiveTaskInfoMapper;
import com.eudemon.flow.ui.task.service.editor.mapper.SequenceFlowInfoMapper;
import com.eudemon.flow.ui.task.service.editor.mapper.ServiceTaskInfoMapper;
import com.eudemon.flow.ui.task.service.editor.mapper.UserTaskInfoMapper;
    ...
    protected ObjectNode processProcessElements(BpmnModel pojoModel, Set<String> completedElements, Set<String> currentElements, Collection<String> breakpoints, String processInstanceId) {
        ...
        if (CollectionUtils.isNotEmpty(pojoModel.getPools())) {
            ...
            for (Pool pool : pojoModel.getPools()) {
                ...
                com.eudemon.flow.bpmn.model.Process process = pojoModel.getProcess(pool.getId());
        ...
        for (com.eudemon.flow.bpmn.model.Process process : pojoModel.getProcesses()) {
