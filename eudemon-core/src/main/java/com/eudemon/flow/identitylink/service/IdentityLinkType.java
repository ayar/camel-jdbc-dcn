 ...
 *
 * @author Joram Barrez
 * @deprecated use {@link com.eudemon.flow.identitylink.api.IdentityLinkType} instead
 */
public class IdentityLinkType extends com.eudemon.flow.identitylink.api.IdentityLinkType {
