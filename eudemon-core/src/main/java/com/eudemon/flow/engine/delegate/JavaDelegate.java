 ...
 * condition defined) If you are in need of influencing the flow in your process, use the class 'com.eudemon.flow.engine.impl.pvm.delegate.ActivityBehavior' instead.
 *
 * @author Joram Barrez
 */
