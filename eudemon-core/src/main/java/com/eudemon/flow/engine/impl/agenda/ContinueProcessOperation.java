...
import com.eudemon.flow.engine.logging.LogMDC;
...
public class ContinueProcessOperation extends AbstractOperation {
    ...
    protected void executeProcessStartExecutionListeners() {
        com.eudemon.flow.bpmn.model.Process process = ProcessDefinitionUtil.getProcess(execution.getProcessDefinitionId());
