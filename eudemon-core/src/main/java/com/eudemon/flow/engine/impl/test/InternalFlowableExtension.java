 ...
 */
package com.eudemon.flow.engine.impl.test;

import static com.eudemon.flow.engine.impl.test.TestHelper.EMPTY_LINE;
...
import com.eudemon.flow.common.engine.impl.test.CleanTest;
...
import com.eudemon.flow.engine.test.Deployment;
import com.eudemon.flow.engine.test.DeploymentId;
import com.eudemon.flow.job.api.HistoryJob;
...
public abstract class InternalFlowableExtension implements AfterEachCallback, BeforeEachCallback, AfterAllCallback, ParameterResolver {
    ...
    protected void removeDeployments(RepositoryService repositoryService) {
        for (com.eudemon.flow.engine.repository.Deployment deployment : repositoryService.createDeploymentQuery().list()) {
            try {
