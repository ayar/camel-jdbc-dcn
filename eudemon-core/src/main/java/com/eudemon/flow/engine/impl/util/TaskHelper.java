...
import com.eudemon.flow.identitylink.service.event.impl.FlowableIdentityLinkEventBuilder;
import com.eudemon.flow.identitylink.api.IdentityLinkEntity;
import com.eudemon.flow.task.api.DelegationState;
...
import com.eudemon.flow.variable.service.event.impl.FlowableVariableEventBuilder;
        ...
        for (TaskEntity task : tasks) {
            if (CommandContextUtil.getEventDispatcher().isEnabled() && !task.isCanceled()) {
                ...
                CommandContextUtil.getEventDispatcher()
                        .dispatchEvent(com.eudemon.flow.engine.delegate.event.impl.FlowableEventBuilder
