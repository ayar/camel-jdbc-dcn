...
import com.eudemon.flow.common.engine.impl.EngineInfo;
import com.eudemon.flow.common.engine.impl.util.IoUtil;
 ...
 * context-listener ( <code>com.eudemon.flow.impl.servlet.listener.ProcessEnginesServletContextListener</code> ). That way, all applications can just use the {@link #getProcessEngines()} to obtain
...
public abstract class ProcessEngines {
    ...
    protected static void initProcessEngineFromSpringResource(URL resource) {
        try {
            Class<?> springConfigurationHelperClass = ReflectUtil.loadClass("com.eudemon.flow.spring.SpringConfigurationHelper");
