...
import com.eudemon.flow.common.engine.api.management.TablePage;
...
import com.eudemon.flow.engine.history.HistoricFormProperty;
import com.eudemon.flow.engine.history.HistoricProcessInstance;
import com.eudemon.flow.engine.history.HistoricVariableUpdate;
import com.eudemon.flow.engine.impl.TablePageQueryImpl;
import com.eudemon.flow.engine.impl.cfg.ProcessEngineConfigurationImpl;
import com.eudemon.flow.engine.impl.persistence.AbstractManager;
...
public class TableDataManagerImpl extends AbstractManager implements TableDataManager {
    ...
    protected long getTableCount(String tableName) {
        ...
        Long count = (Long) getDbSqlSession().selectOne("com.eudemon.flow.engine.impl.TablePageMap.selectTableCount", Collections.singletonMap("tableName", tableName));
        return count;
    }
    ...
    public TablePage getTablePage(TablePageQueryImpl tablePageQuery, int firstResult, int maxResults) {
        ...
        List tableData = getDbSqlSession().getSqlSession().selectList("com.eudemon.flow.engine.impl.TablePageMap.selectTableData", tablePageQuery, new RowBounds(firstResult, maxResults));
