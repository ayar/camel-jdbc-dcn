 ...
 */
package com.eudemon.flow.engine.runtime;
...
import com.eudemon.flow.common.engine.api.query.Query;
...
public interface ProcessInstanceQuery extends Query<ProcessInstanceQuery, ProcessInstance> {
    ...
    /**
     * Select the process instances with which the {@link com.eudemon.flow.idm.api.Group}s with the given ids are involved.
     */
