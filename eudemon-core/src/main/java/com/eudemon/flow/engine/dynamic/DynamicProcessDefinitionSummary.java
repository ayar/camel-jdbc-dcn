 ...
 */
package com.eudemon.flow.engine.dynamic;
...
/**
 * Pojo class who can be used to check information between {@link com.eudemon.flow.engine.DynamicBpmnService#getProcessDefinitionInfo(String)} and {@link BpmnModel}. Without
...
public class DynamicProcessDefinitionSummary implements DynamicBpmnConstants {
     ...
     *     "elementSummary": {
     *         "{@link com.eudemon.flow.engine.DynamicBpmnConstants} linked to the elementType": {
     ...
     *
     * <p>
     * If no value is found for a given {@link com.eudemon.flow.engine.DynamicBpmnConstants} in the {@link BpmnModel} or ProcessDefinitionInfo. we don't store an key in the resulting {@link ObjectNode}.
     ...
     *
     * @param elementId
     *            the id of the {@link FlowElement}.
     * @return an {@link ObjectNode} with the provided structure.
     * @throws IllegalStateException
     *             if no {@link FlowElement} is found for the provided id.
     */
