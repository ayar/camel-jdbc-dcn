...
import com.eudemon.flow.engine.form.FormData;
import com.eudemon.flow.engine.impl.cfg.ProcessEngineConfigurationImpl;
import com.eudemon.flow.engine.impl.cmd.ActivateProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.AddEventListenerCommand;
import com.eudemon.flow.engine.impl.cmd.AddIdentityLinkForProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.AddMultiInstanceExecutionCmd;
import com.eudemon.flow.engine.impl.cmd.ChangeActivityStateCmd;
import com.eudemon.flow.engine.impl.cmd.CompleteAdhocSubProcessCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteIdentityLinkForProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteMultiInstanceExecutionCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.DispatchEventCommand;
import com.eudemon.flow.engine.impl.cmd.ExecuteActivityForAdhocSubProcessCmd;
import com.eudemon.flow.engine.impl.cmd.FindActiveActivityIdsCmd;
import com.eudemon.flow.engine.impl.cmd.GetActiveAdhocSubProcessesCmd;
import com.eudemon.flow.engine.impl.cmd.GetDataObjectCmd;
import com.eudemon.flow.engine.impl.cmd.GetDataObjectsCmd;
import com.eudemon.flow.engine.impl.cmd.GetEnabledActivitiesForAdhocSubProcessCmd;
import com.eudemon.flow.engine.impl.cmd.GetEntityLinkChildrenForProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.GetExecutionVariableCmd;
import com.eudemon.flow.engine.impl.cmd.GetExecutionVariableInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.GetExecutionVariableInstancesCmd;
import com.eudemon.flow.engine.impl.cmd.GetExecutionVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.GetExecutionsVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.GetIdentityLinksForProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.GetProcessInstanceEventsCmd;
import com.eudemon.flow.engine.impl.cmd.GetStartFormCmd;
import com.eudemon.flow.engine.impl.cmd.GetStartFormModelCmd;
import com.eudemon.flow.engine.impl.cmd.HasExecutionVariableCmd;
import com.eudemon.flow.engine.impl.cmd.MessageEventReceivedCmd;
import com.eudemon.flow.engine.impl.cmd.ProcessInstanceMigrationCmd;
import com.eudemon.flow.engine.impl.cmd.ProcessInstanceMigrationValidationCmd;
import com.eudemon.flow.engine.impl.cmd.RemoveEventListenerCommand;
import com.eudemon.flow.engine.impl.cmd.RemoveExecutionVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.SetExecutionVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.SetProcessInstanceBusinessKeyCmd;
import com.eudemon.flow.engine.impl.cmd.SetProcessInstanceNameCmd;
import com.eudemon.flow.engine.impl.cmd.SignalEventReceivedCmd;
import com.eudemon.flow.engine.impl.cmd.StartProcessInstanceAsyncCmd;
import com.eudemon.flow.engine.impl.cmd.StartProcessInstanceByMessageCmd;
import com.eudemon.flow.engine.impl.cmd.StartProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.StartProcessInstanceWithFormCmd;
import com.eudemon.flow.engine.impl.cmd.SuspendProcessInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.TriggerCmd;
import com.eudemon.flow.engine.impl.migration.ProcessInstanceMigrationBuilderImpl;
import com.eudemon.flow.engine.impl.migration.ProcessInstanceMigrationValidationResult;
...
import com.eudemon.flow.engine.migration.ProcessInstanceMigrationBuilder;
import com.eudemon.flow.engine.migration.ProcessInstanceMigrationDocument;
import com.eudemon.flow.engine.runtime.ChangeActivityStateBuilder;
import com.eudemon.flow.engine.runtime.DataObject;
import com.eudemon.flow.engine.runtime.EventSubscriptionQuery;
import com.eudemon.flow.engine.runtime.Execution;
import com.eudemon.flow.engine.runtime.ExecutionQuery;
import com.eudemon.flow.engine.runtime.NativeExecutionQuery;
import com.eudemon.flow.engine.runtime.NativeProcessInstanceQuery;
import com.eudemon.flow.engine.runtime.ProcessInstance;
import com.eudemon.flow.engine.runtime.ProcessInstanceBuilder;
import com.eudemon.flow.engine.runtime.ProcessInstanceQuery;
import com.eudemon.flow.engine.task.Event;
import com.eudemon.flow.entitylink.api.EntityLink;
