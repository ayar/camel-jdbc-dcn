...
import com.eudemon.flow.engine.form.FormProperty;
...
public class DefaultFormHandler implements FormHandler {
    ...
    @Override
    public void parseConfiguration(List<com.eudemon.flow.bpmn.model.FormProperty> formProperties, String formKey, DeploymentEntity deployment, ProcessDefinition processDefinition) {
        ...
        for (com.eudemon.flow.bpmn.model.FormProperty formProperty : formProperties) {
