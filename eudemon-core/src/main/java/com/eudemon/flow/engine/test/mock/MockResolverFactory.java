...
import com.eudemon.flow.common.engine.impl.scripting.Resolver;
...
/**
 * This is a bridge resolver, making available any objects registered through {@link Mocks#register} inside scripts supported by process execution. <br>
 * <br>
 ...
 * class=&quot;com.eudemon.flow.engine.impl.cfg. StandaloneInMemProcessEngineConfiguration&quot;&gt;<br>
 * &lt;property name=&quot;expressionManager&quot;&gt;<br>
 * &lt;bean class=&quot;com.eudemon.flow.engine.test.mock.MockExpressionManager&quot; /&gt;<br>
 * &lt;/property&gt;<br>
 * &lt;property name=&quot;resolverFactories&quot;&gt;<br>
 * &lt;list&gt;<br>
 * &lt;bean class=&quot;com.eudemon.flow.common.engine.impl.scripting.VariableScopeResolverFactory &quot; /&gt;<br>
 * &lt;bean class=&quot;com.eudemon.flow.common.engine.impl.scripting.BeansResolverFactory&quot; /&gt;<br>
