...
import com.eudemon.flow.bpmn.model.TaskWithFieldExtensions;
import com.eudemon.flow.bpmn.model.TerminateEventDefinition;
...
import com.eudemon.flow.engine.delegate.BusinessRuleTaskDelegate;
...
import com.eudemon.flow.engine.impl.bpmn.behavior.BusinessRuleTaskActivityBehavior;
...
import com.eudemon.flow.engine.impl.bpmn.behavior.DmnActivityBehavior;
...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory implements ActivityBehaviorFactory {
    ...
    protected ActivityBehavior createMuleActivityBehavior(TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions) {
        try {
            ...
            Class<?> theClass = Class.forName("com.eudemon.flow.mule.MuleSendActivityBehavior");
            ...
            throw new FlowableException("Could not find com.eudemon.flow.mule.MuleSendActivityBehavior: ", e);
        }
    }
    ...
    protected ActivityBehavior createCamelActivityBehavior(TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions) {
        try {
            ...
            throw new FlowableException("Could not find com.eudemon.flow.camel.CamelBehavior: ", e);
        }
    }

	protected String getDefaultCamelBehaviorClassName() {
		return "com.eudemon.flow.camel.impl.CamelBehaviorDefaultImpl";
	}
    ...
    public ActivityBehavior createHttpActivityBehavior(ServiceTask serviceTask) {
        try {
            ...
            if (theClass == null) {
                ...
                theClass = Class.forName("com.eudemon.flow.http.bpmn.impl.HttpActivityBehaviorImpl");
            }
            ...
            throw new FlowableException("Could not find com.eudemon.flow.http.HttpActivityBehavior: ", e);
        }
    }
    ...
    public ActivityBehavior createBusinessRuleTaskActivityBehavior(BusinessRuleTask businessRuleTask) {
        ...
        if (businessRuleTask.getResultVariableName() != null && businessRuleTask.getResultVariableName().length() > 0) {
            ...
            ruleActivity.setResultVariable("com.eudemon.flow.engine.rules.OUTPUT");
        }
