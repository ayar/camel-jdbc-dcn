...
import com.eudemon.flow.bpmn.model.DataAssociation;
import com.eudemon.flow.bpmn.model.DataSpec;
import com.eudemon.flow.bpmn.model.FlowElement;
import com.eudemon.flow.bpmn.model.IOSpecification;
import com.eudemon.flow.bpmn.model.Import;
import com.eudemon.flow.bpmn.model.Interface;
import com.eudemon.flow.bpmn.model.Message;
...
import com.eudemon.flow.common.engine.impl.util.ReflectUtil;
import com.eudemon.flow.engine.delegate.BpmnError;
import com.eudemon.flow.engine.delegate.DelegateExecution;
import com.eudemon.flow.engine.impl.bpmn.data.AbstractDataAssociation;
import com.eudemon.flow.engine.impl.bpmn.data.Assignment;
import com.eudemon.flow.engine.impl.bpmn.data.ClassStructureDefinition;
import com.eudemon.flow.engine.impl.bpmn.data.ItemDefinition;
import com.eudemon.flow.engine.impl.bpmn.data.ItemInstance;
import com.eudemon.flow.engine.impl.bpmn.data.ItemKind;
import com.eudemon.flow.engine.impl.bpmn.data.SimpleDataInputAssociation;
import com.eudemon.flow.engine.impl.bpmn.data.StructureDefinition;
import com.eudemon.flow.engine.impl.bpmn.data.TransformationDataOutputAssociation;
import com.eudemon.flow.engine.impl.bpmn.helper.ErrorPropagation;
import com.eudemon.flow.engine.impl.bpmn.parser.XMLImporter;
import com.eudemon.flow.engine.impl.bpmn.webservice.BpmnInterface;
import com.eudemon.flow.engine.impl.bpmn.webservice.MessageDefinition;
import com.eudemon.flow.engine.impl.bpmn.webservice.MessageImplicitDataInputAssociation;
import com.eudemon.flow.engine.impl.bpmn.webservice.MessageImplicitDataOutputAssociation;
import com.eudemon.flow.engine.impl.bpmn.webservice.MessageInstance;
import com.eudemon.flow.engine.impl.bpmn.webservice.Operation;
...
import com.eudemon.flow.engine.impl.webservice.WSOperation;
import com.eudemon.flow.engine.impl.webservice.WSService;
...
public class WebServiceActivityBehavior extends AbstractBpmnActivityBehavior {
    ...
    public static final String CURRENT_MESSAGE = "com.eudemon.flow.engine.impl.bpmn.CURRENT_MESSAGE";
    ...
    protected void createItemDefinitions(BpmnModel bpmnModel) {
        ...
        for (com.eudemon.flow.bpmn.model.ItemDefinition itemDefinitionElement : bpmnModel.getItemDefinitions().values()) {
    ...
    protected void createOperations(BpmnModel bpmnModel) {
        for (Interface interfaceObject : bpmnModel.getInterfaces()) {
            ...
            for (com.eudemon.flow.bpmn.model.Operation operationObject : interfaceObject.getOperations()) {
    ...
    protected AbstractDataAssociation createDataInputAssociation(DataAssociation dataAssociationElement) {
        if (dataAssociationElement.getAssignments().isEmpty()) {
            ...
            for (com.eudemon.flow.bpmn.model.Assignment assignmentElement : dataAssociationElement.getAssignments()) {
