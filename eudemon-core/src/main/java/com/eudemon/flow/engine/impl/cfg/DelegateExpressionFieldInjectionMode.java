...
import com.eudemon.flow.engine.delegate.DelegateHelper;
...
public enum DelegateExpressionFieldInjectionMode {
     ...
     *
     * Using the {@link DelegateHelper#getField(com.eudemon.flow.engine.delegate.DelegateExecution, String)} method is not possible when using this mode, unless the Expressions are still defined as
