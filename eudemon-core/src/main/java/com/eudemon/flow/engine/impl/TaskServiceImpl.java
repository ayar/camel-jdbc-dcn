...
import com.eudemon.flow.engine.impl.cmd.AddCommentCmd;
import com.eudemon.flow.engine.impl.cmd.AddIdentityLinkCmd;
import com.eudemon.flow.engine.impl.cmd.ClaimTaskCmd;
import com.eudemon.flow.engine.impl.cmd.CompleteTaskCmd;
import com.eudemon.flow.engine.impl.cmd.CompleteTaskWithFormCmd;
import com.eudemon.flow.engine.impl.cmd.CreateAttachmentCmd;
import com.eudemon.flow.engine.impl.cmd.DelegateTaskCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteAttachmentCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteCommentCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteIdentityLinkCmd;
import com.eudemon.flow.engine.impl.cmd.DeleteTaskCmd;
import com.eudemon.flow.engine.impl.cmd.GetAttachmentCmd;
import com.eudemon.flow.engine.impl.cmd.GetAttachmentContentCmd;
import com.eudemon.flow.engine.impl.cmd.GetCommentCmd;
import com.eudemon.flow.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import com.eudemon.flow.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import com.eudemon.flow.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import com.eudemon.flow.engine.impl.cmd.GetSubTasksCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskAttachmentsCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskCommentsByTypeCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskCommentsCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskDataObjectCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskDataObjectsCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskEventCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskEventsCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskFormModelCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskVariableCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskVariableInstanceCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskVariableInstancesCmd;
import com.eudemon.flow.engine.impl.cmd.GetTaskVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.GetTasksLocalVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.GetTypeCommentsCmd;
import com.eudemon.flow.engine.impl.cmd.HasTaskVariableCmd;
import com.eudemon.flow.engine.impl.cmd.NewTaskCmd;
import com.eudemon.flow.engine.impl.cmd.RemoveTaskVariablesCmd;
import com.eudemon.flow.engine.impl.cmd.ResolveTaskCmd;
import com.eudemon.flow.engine.impl.cmd.SaveAttachmentCmd;
import com.eudemon.flow.engine.impl.cmd.SaveCommentCmd;
import com.eudemon.flow.engine.impl.cmd.SaveTaskCmd;
import com.eudemon.flow.engine.impl.cmd.SetTaskDueDateCmd;
import com.eudemon.flow.engine.impl.cmd.SetTaskPriorityCmd;
import com.eudemon.flow.engine.impl.cmd.SetTaskVariablesCmd;
...
import com.eudemon.flow.task.api.NativeTaskQuery;
import com.eudemon.flow.task.api.Task;
import com.eudemon.flow.task.api.TaskBuilder;
import com.eudemon.flow.task.api.TaskQuery;
import com.eudemon.flow.task.service.impl.NativeTaskQueryImpl;
import com.eudemon.flow.task.service.impl.TaskQueryImpl;
