...
public interface DynamicBpmnService {
    ...
    /**
     * <p>
     * Clears the field from the infoNode. So the engine uses the {@link com.eudemon.flow.bpmn.model.BpmnModel} value On next instance.
     * </p>
     *
     * <p color="red">
    ...
    /**
     * Gives a summary between the {@link com.eudemon.flow.bpmn.model.BpmnModel} and {@link DynamicBpmnService#getProcessDefinitionInfo(String)}
     *
