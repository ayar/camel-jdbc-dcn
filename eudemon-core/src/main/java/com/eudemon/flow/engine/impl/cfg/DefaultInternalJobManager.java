...
public class DefaultInternalJobManager implements InternalJobManager {
    ...
    public void preTimerJobDelete(JobEntity jobEntity, VariableScope variableScope) {
        ...
        if (jobEntity.getProcessDefinitionId() != null) {
            com.eudemon.flow.bpmn.model.Process process = ProcessDefinitionUtil.getProcess(jobEntity.getProcessDefinitionId());
    ...
    protected int getMaxIterations(com.eudemon.flow.bpmn.model.Process process, String activityId) {
