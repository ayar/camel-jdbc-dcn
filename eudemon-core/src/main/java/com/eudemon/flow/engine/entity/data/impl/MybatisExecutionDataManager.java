...
import com.eudemon.flow.common.engine.api.FlowableOptimisticLockingException;
import com.eudemon.flow.common.engine.impl.db.SingleCachedEntityMatcher;
import com.eudemon.flow.common.engine.impl.persistence.cache.CachedEntityMatcher;
import com.eudemon.flow.engine.impl.ExecutionQueryImpl;
import com.eudemon.flow.engine.impl.ProcessInstanceQueryImpl;
import com.eudemon.flow.engine.impl.cfg.PerformanceSettings;
...
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionByProcessInstanceMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionsByParentExecutionIdAndActivityIdEntityMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionsByParentExecutionIdEntityMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionsByProcessInstanceIdEntityMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionsByRootProcessInstanceMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ExecutionsWithSameRootProcessInstanceIdMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.InactiveExecutionsByProcInstMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.InactiveExecutionsInActivityAndProcInstMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.InactiveExecutionsInActivityMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.ProcessInstancesByProcessDefinitionMatcher;
import com.eudemon.flow.engine.entity.data.impl.cachematcher.SubProcessInstanceExecutionBySuperExecutionIdMatcher;
