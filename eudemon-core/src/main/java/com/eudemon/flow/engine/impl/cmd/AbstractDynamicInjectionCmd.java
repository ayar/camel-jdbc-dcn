...
import com.eudemon.flow.common.engine.impl.util.io.BytesStreamSource;
import com.eudemon.flow.engine.impl.dynamic.BaseDynamicSubProcessInjectUtil;
...
public abstract class AbstractDynamicInjectionCmd {
    ...
    protected BpmnModel createBpmnModel(CommandContext commandContext, ProcessDefinitionEntity originalProcessDefinitionEntity, DeploymentEntity newDeploymentEntity) {
        ...
        com.eudemon.flow.bpmn.model.Process process = bpmnModel.getProcessById(originalProcessDefinitionEntity.getKey());
        updateBpmnProcess(commandContext, process, bpmnModel, originalProcessDefinitionEntity, newDeploymentEntity);
        return bpmnModel;
    }

    protected abstract void updateBpmnProcess(CommandContext commandContext, com.eudemon.flow.bpmn.model.Process process,
