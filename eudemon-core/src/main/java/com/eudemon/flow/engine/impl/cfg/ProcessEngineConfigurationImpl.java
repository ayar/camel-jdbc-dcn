...
import com.eudemon.flow.common.engine.api.delegate.FlowableExpressionEnhancer;
import com.eudemon.flow.common.engine.api.delegate.FlowableFunctionDelegate;
...
import com.eudemon.flow.common.engine.impl.EngineConfigurator;
import com.eudemon.flow.common.engine.impl.EngineDeployer;
import com.eudemon.flow.common.engine.impl.HasExpressionManagerEngineConfiguration;
import com.eudemon.flow.common.engine.impl.ScriptingEngineAwareEngineConfiguration;
import com.eudemon.flow.common.engine.impl.calendar.BusinessCalendarManager;
...
import com.eudemon.flow.common.engine.impl.calendar.MapBusinessCalendarManager;
import com.eudemon.flow.common.engine.impl.callback.RuntimeInstanceStateChangeCallback;
import com.eudemon.flow.common.engine.impl.cfg.IdGenerator;
import com.eudemon.flow.common.engine.impl.db.AbstractDataManager;
import com.eudemon.flow.common.engine.impl.db.SchemaManager;
import com.eudemon.flow.common.engine.impl.el.ExpressionManager;
import com.eudemon.flow.common.engine.impl.el.function.FlowableShortHandExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableContainsAnyExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableContainsExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableEqualsExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableExistsExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableGetExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableGetOrDefaultExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableGreaterThanExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableGreaterThanOrEqualsExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableIsEmptyExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableIsNotEmptyExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableLowerThanExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableLowerThanOrEqualsExpressionFunction;
import com.eudemon.flow.common.engine.impl.el.function.VariableNotEqualsExpressionFunction;
import com.eudemon.flow.common.engine.impl.event.FlowableEventDispatcherImpl;
...
import com.eudemon.flow.common.engine.impl.persistence.GenericManagerFactory;
import com.eudemon.flow.common.engine.impl.persistence.cache.EntityCache;
import com.eudemon.flow.common.engine.impl.persistence.cache.EntityCacheImpl;
import com.eudemon.flow.common.engine.impl.persistence.deploy.DefaultDeploymentCache;
...
import com.eudemon.flow.common.engine.impl.scripting.BeansResolverFactory;
import com.eudemon.flow.common.engine.impl.scripting.ResolverFactory;
import com.eudemon.flow.common.engine.impl.scripting.ScriptBindingsFactory;
import com.eudemon.flow.common.engine.impl.scripting.ScriptingEngines;
import com.eudemon.flow.engine.CandidateManager;
import com.eudemon.flow.engine.DefaultCandidateManager;
import com.eudemon.flow.engine.DynamicBpmnService;
import com.eudemon.flow.engine.ExecutionQueryInterceptor;
...
import com.eudemon.flow.engine.HistoricProcessInstanceQueryInterceptor;
...
import com.eudemon.flow.engine.ProcessInstanceQueryInterceptor;
...
import com.eudemon.flow.engine.app.AppResourceConverter;
import com.eudemon.flow.engine.compatibility.DefaultFlowable5CompatibilityHandlerFactory;
import com.eudemon.flow.engine.compatibility.Flowable5CompatibilityHandler;
import com.eudemon.flow.engine.compatibility.Flowable5CompatibilityHandlerFactory;
import com.eudemon.flow.engine.delegate.event.impl.BpmnModelEventDispatchAction;
import com.eudemon.flow.engine.dynamic.DynamicStateManager;
import com.eudemon.flow.engine.form.AbstractFormType;
import com.eudemon.flow.engine.impl.DefaultProcessJobParentStateResolver;
import com.eudemon.flow.engine.impl.DynamicBpmnServiceImpl;
import com.eudemon.flow.engine.impl.FormServiceImpl;
import com.eudemon.flow.engine.impl.HistoryServiceImpl;
import com.eudemon.flow.engine.impl.IdentityServiceImpl;
import com.eudemon.flow.engine.impl.ManagementServiceImpl;
import com.eudemon.flow.engine.impl.ProcessEngineImpl;
import com.eudemon.flow.engine.impl.RepositoryServiceImpl;
import com.eudemon.flow.engine.impl.RuntimeServiceImpl;
import com.eudemon.flow.engine.impl.SchemaOperationProcessEngineClose;
import com.eudemon.flow.engine.impl.SchemaOperationsProcessEngineBuild;
import com.eudemon.flow.engine.impl.TaskServiceImpl;
import com.eudemon.flow.engine.impl.agenda.AgendaSessionFactory;
import com.eudemon.flow.engine.impl.agenda.DefaultFlowableEngineAgendaFactory;
import com.eudemon.flow.engine.impl.app.AppDeployer;
import com.eudemon.flow.engine.impl.app.AppResourceConverterImpl;
import com.eudemon.flow.engine.impl.bpmn.data.ItemInstance;
import com.eudemon.flow.engine.impl.bpmn.deployer.BpmnDeployer;
import com.eudemon.flow.engine.impl.bpmn.deployer.BpmnDeploymentHelper;
import com.eudemon.flow.engine.impl.bpmn.deployer.CachingAndArtifactsManager;
import com.eudemon.flow.engine.impl.bpmn.deployer.EventSubscriptionManager;
import com.eudemon.flow.engine.impl.bpmn.deployer.ParsedDeploymentBuilderFactory;
import com.eudemon.flow.engine.impl.bpmn.deployer.ProcessDefinitionDiagramHelper;
import com.eudemon.flow.engine.impl.bpmn.deployer.TimerManager;
import com.eudemon.flow.engine.impl.bpmn.listener.ListenerNotificationHelper;
import com.eudemon.flow.engine.impl.bpmn.parser.BpmnParseHandlers;
...
import com.eudemon.flow.engine.impl.bpmn.parser.factory.DefaultActivityBehaviorFactory;
import com.eudemon.flow.engine.impl.bpmn.parser.factory.DefaultListenerFactory;
import com.eudemon.flow.engine.impl.bpmn.parser.factory.DefaultXMLImporterFactory;
import com.eudemon.flow.engine.impl.bpmn.parser.factory.ListenerFactory;
import com.eudemon.flow.engine.impl.bpmn.parser.factory.XMLImporterFactory;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.AdhocSubProcessParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.BoundaryEventParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.BusinessRuleParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.CallActivityParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.CancelEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.CompensateEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.EndEventParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ErrorEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.EventBasedGatewayParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.EventSubProcessParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ExclusiveGatewayParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.HttpServiceTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.InclusiveGatewayParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.IntermediateCatchEventParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.IntermediateThrowEventParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ManualTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.MessageEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ParallelGatewayParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ProcessParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ReceiveTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ScriptTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.SendTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.SequenceFlowParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.ServiceTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.SignalEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.StartEventParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.SubProcessParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.TaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.TimerEventDefinitionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.TransactionParseHandler;
import com.eudemon.flow.engine.impl.bpmn.parser.handler.UserTaskParseHandler;
import com.eudemon.flow.engine.impl.bpmn.webservice.MessageInstance;
import com.eudemon.flow.engine.impl.cmd.RedeployV5ProcessDefinitionsCmd;
import com.eudemon.flow.engine.impl.cmd.ValidateExecutionRelatedEntityCountCfgCmd;
import com.eudemon.flow.engine.impl.cmd.ValidateTaskRelatedEntityCountCfgCmd;
import com.eudemon.flow.engine.impl.cmd.ValidateV5EntitiesCmd;
import com.eudemon.flow.engine.impl.db.DbIdGenerator;
import com.eudemon.flow.engine.impl.db.EntityDependencyOrder;
import com.eudemon.flow.engine.impl.db.ProcessDbSchemaManager;
import com.eudemon.flow.engine.impl.delegate.invocation.DefaultDelegateInterceptor;
import com.eudemon.flow.engine.impl.dynamic.DefaultDynamicStateManager;
import com.eudemon.flow.engine.impl.el.FlowableDateFunctionDelegate;
import com.eudemon.flow.engine.impl.el.ProcessExpressionManager;
import com.eudemon.flow.engine.impl.event.CompensationEventHandler;
import com.eudemon.flow.engine.impl.event.EventHandler;
...
import com.eudemon.flow.engine.impl.event.logger.EventLogger;
import com.eudemon.flow.engine.impl.form.BooleanFormType;
import com.eudemon.flow.engine.impl.form.DateFormType;
import com.eudemon.flow.engine.impl.form.DoubleFormType;
import com.eudemon.flow.engine.impl.form.FormEngine;
import com.eudemon.flow.engine.impl.form.FormHandlerHelper;
import com.eudemon.flow.engine.impl.form.FormTypes;
import com.eudemon.flow.engine.impl.form.JuelFormEngine;
import com.eudemon.flow.engine.impl.form.LongFormType;
import com.eudemon.flow.engine.impl.form.StringFormType;
import com.eudemon.flow.engine.impl.formhandler.DefaultFormFieldHandler;
import com.eudemon.flow.engine.impl.history.DefaultHistoryManager;
import com.eudemon.flow.engine.impl.history.DefaultHistoryTaskManager;
import com.eudemon.flow.engine.impl.history.DefaultHistoryVariableManager;
import com.eudemon.flow.engine.impl.history.HistoryManager;
import com.eudemon.flow.engine.impl.history.async.AsyncHistoryManager;
import com.eudemon.flow.engine.impl.history.async.HistoryJsonConstants;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ActivityEndHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ActivityFullHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ActivityStartHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.EntityLinkCreatedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.EntityLinkDeletedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.FormPropertiesSubmittedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.HistoricDetailVariableUpdateHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.IdentityLinkCreatedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.IdentityLinkDeletedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ProcessInstanceDeleteHistoryByProcessDefinitionIdJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ProcessInstanceDeleteHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ProcessInstanceEndHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ProcessInstancePropertyChangedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.ProcessInstanceStartHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.SetProcessDefinitionHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.SubProcessInstanceStartHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.TaskAssigneeChangedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.TaskCreatedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.TaskEndedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.TaskOwnerChangedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.TaskPropertyChangedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.UpdateProcessDefinitionCascadeHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.VariableCreatedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.VariableRemovedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.history.async.json.transformer.VariableUpdatedHistoryJsonTransformer;
import com.eudemon.flow.engine.impl.interceptor.BpmnOverrideContextInterceptor;
import com.eudemon.flow.engine.impl.interceptor.CommandInvoker;
import com.eudemon.flow.engine.impl.interceptor.DelegateInterceptor;
import com.eudemon.flow.engine.impl.interceptor.LoggingExecutionTreeCommandInvoker;
import com.eudemon.flow.engine.impl.jobexecutor.AsyncCompleteCallActivityJobHandler;
...
import com.eudemon.flow.engine.impl.jobexecutor.DefaultFailedJobCommandFactory;
import com.eudemon.flow.engine.impl.jobexecutor.ProcessEventJobHandler;
import com.eudemon.flow.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
import com.eudemon.flow.engine.impl.jobexecutor.TimerStartEventJobHandler;
import com.eudemon.flow.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
import com.eudemon.flow.engine.impl.jobexecutor.TriggerTimerEventJobHandler;
import com.eudemon.flow.engine.impl.migration.ProcessInstanceMigrationManagerImpl;
...
import com.eudemon.flow.engine.impl.persistence.deploy.ProcessDefinitionInfoCache;
import com.eudemon.flow.engine.entity.AttachmentEntityManager;
import com.eudemon.flow.engine.entity.AttachmentEntityManagerImpl;
import com.eudemon.flow.engine.entity.ByteArrayEntityManager;
import com.eudemon.flow.engine.entity.ByteArrayEntityManagerImpl;
import com.eudemon.flow.engine.entity.CommentEntityManager;
import com.eudemon.flow.engine.entity.CommentEntityManagerImpl;
import com.eudemon.flow.engine.entity.DeploymentEntityManager;
import com.eudemon.flow.engine.entity.DeploymentEntityManagerImpl;
import com.eudemon.flow.engine.entity.EventLogEntryEntityImpl;
import com.eudemon.flow.engine.entity.EventLogEntryEntityManager;
import com.eudemon.flow.engine.entity.EventLogEntryEntityManagerImpl;
import com.eudemon.flow.engine.entity.EventSubscriptionEntityManager;
import com.eudemon.flow.engine.entity.EventSubscriptionEntityManagerImpl;
import com.eudemon.flow.engine.entity.ExecutionEntityManager;
import com.eudemon.flow.engine.entity.ExecutionEntityManagerImpl;
import com.eudemon.flow.engine.entity.HistoricActivityInstanceEntityManager;
import com.eudemon.flow.engine.entity.HistoricActivityInstanceEntityManagerImpl;
import com.eudemon.flow.engine.entity.HistoricDetailEntityManager;
import com.eudemon.flow.engine.entity.HistoricDetailEntityManagerImpl;
import com.eudemon.flow.engine.entity.HistoricProcessInstanceEntityManager;
import com.eudemon.flow.engine.entity.HistoricProcessInstanceEntityManagerImpl;
import com.eudemon.flow.engine.entity.ModelEntityManager;
import com.eudemon.flow.engine.entity.ModelEntityManagerImpl;
import com.eudemon.flow.engine.entity.ProcessDefinitionEntityManager;
import com.eudemon.flow.engine.entity.ProcessDefinitionEntityManagerImpl;
import com.eudemon.flow.engine.entity.ProcessDefinitionInfoEntityManager;
import com.eudemon.flow.engine.entity.ProcessDefinitionInfoEntityManagerImpl;
import com.eudemon.flow.engine.entity.PropertyEntityManager;
import com.eudemon.flow.engine.entity.PropertyEntityManagerImpl;
import com.eudemon.flow.engine.entity.ResourceEntityManager;
import com.eudemon.flow.engine.entity.ResourceEntityManagerImpl;
import com.eudemon.flow.engine.entity.TableDataManager;
import com.eudemon.flow.engine.entity.TableDataManagerImpl;
...
import com.eudemon.flow.engine.entity.data.CommentDataManager;
import com.eudemon.flow.engine.entity.data.DeploymentDataManager;
import com.eudemon.flow.engine.entity.data.EventLogEntryDataManager;
import com.eudemon.flow.engine.entity.data.EventSubscriptionDataManager;
import com.eudemon.flow.engine.entity.data.ExecutionDataManager;
...
import com.eudemon.flow.engine.entity.data.HistoricProcessInstanceDataManager;
import com.eudemon.flow.engine.entity.data.ModelDataManager;
import com.eudemon.flow.engine.entity.data.ProcessDefinitionDataManager;
import com.eudemon.flow.engine.entity.data.ProcessDefinitionInfoDataManager;
import com.eudemon.flow.engine.entity.data.PropertyDataManager;
import com.eudemon.flow.engine.entity.data.ResourceDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisAttachmentDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisByteArrayDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisCommentDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisDeploymentDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisEventLogEntryDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisEventSubscriptionDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisExecutionDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisHistoricActivityInstanceDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisHistoricDetailDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisHistoricProcessInstanceDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisModelDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisProcessDefinitionDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisProcessDefinitionInfoDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisPropertyDataManager;
import com.eudemon.flow.engine.entity.data.impl.MybatisResourceDataManager;
import com.eudemon.flow.engine.impl.scripting.VariableScopeResolverFactory;
import com.eudemon.flow.engine.impl.util.ProcessInstanceHelper;
import com.eudemon.flow.engine.migration.ProcessInstanceMigrationManager;
import com.eudemon.flow.engine.parse.BpmnParseHandler;
import com.eudemon.flow.entitylink.service.EntityLinkServiceConfiguration;
import com.eudemon.flow.entitylink.service.impl.db.EntityLinkDbSchemaManager;
import com.eudemon.flow.form.api.FormFieldHandler;
import com.eudemon.flow.identitylink.service.IdentityLinkEventHandler;
import com.eudemon.flow.identitylink.service.IdentityLinkServiceConfiguration;
import com.eudemon.flow.identitylink.service.impl.db.IdentityLinkDbSchemaManager;
import com.eudemon.flow.idm.api.IdmEngineConfigurationApi;
import com.eudemon.flow.idm.engine.configurator.IdmEngineConfigurator;
import com.eudemon.flow.image.impl.DefaultProcessDiagramGenerator;
import com.eudemon.flow.job.service.HistoryJobHandler;
import com.eudemon.flow.job.service.HistoryJobProcessor;
import com.eudemon.flow.job.service.InternalJobCompatibilityManager;
import com.eudemon.flow.job.service.InternalJobManager;
import com.eudemon.flow.job.service.InternalJobParentStateResolver;
import com.eudemon.flow.job.service.JobHandler;
import com.eudemon.flow.job.service.JobProcessor;
import com.eudemon.flow.job.service.JobServiceConfiguration;
import com.eudemon.flow.job.service.impl.asyncexecutor.AsyncExecutor;
import com.eudemon.flow.job.service.impl.asyncexecutor.AsyncRunnableExecutionExceptionHandler;
import com.eudemon.flow.job.service.impl.asyncexecutor.DefaultAsyncHistoryJobExecutor;
import com.eudemon.flow.job.service.impl.asyncexecutor.DefaultAsyncJobExecutor;
import com.eudemon.flow.job.service.impl.asyncexecutor.DefaultAsyncRunnableExecutionExceptionHandler;
import com.eudemon.flow.job.service.impl.asyncexecutor.ExecuteAsyncRunnableFactory;
import com.eudemon.flow.job.service.impl.asyncexecutor.FailedJobCommandFactory;
import com.eudemon.flow.job.service.impl.asyncexecutor.JobManager;
import com.eudemon.flow.job.service.impl.db.JobDbSchemaManager;
import com.eudemon.flow.job.service.impl.history.async.AsyncHistoryJobHandler;
import com.eudemon.flow.job.service.impl.history.async.AsyncHistoryJobZippedHandler;
import com.eudemon.flow.job.service.impl.history.async.AsyncHistoryListener;
import com.eudemon.flow.job.service.impl.history.async.AsyncHistorySession;
import com.eudemon.flow.job.service.impl.history.async.AsyncHistorySessionFactory;
import com.eudemon.flow.job.service.impl.history.async.DefaultAsyncHistoryJobProducer;
import com.eudemon.flow.job.service.impl.history.async.transformer.HistoryJsonTransformer;
import com.eudemon.flow.task.api.TaskQueryInterceptor;
import com.eudemon.flow.task.api.history.HistoricTaskQueryInterceptor;
import com.eudemon.flow.task.service.InternalTaskAssignmentManager;
import com.eudemon.flow.task.service.InternalTaskLocalizationManager;
import com.eudemon.flow.task.service.InternalTaskVariableScopeResolver;
import com.eudemon.flow.task.service.TaskServiceConfiguration;
import com.eudemon.flow.task.service.InternalHistoryTaskManager;
import com.eudemon.flow.task.service.impl.DefaultTaskPostProcessor;
import com.eudemon.flow.task.service.impl.db.TaskDbSchemaManager;
import com.eudemon.flow.validation.ProcessValidator;
import com.eudemon.flow.validation.ProcessValidatorFactory;
import com.eudemon.flow.variable.api.types.VariableType;
import com.eudemon.flow.variable.api.types.VariableTypes;
import com.eudemon.flow.variable.service.VariableServiceConfiguration;
import com.eudemon.flow.variable.service.history.InternalHistoryVariableManager;
import com.eudemon.flow.variable.service.impl.db.IbatisVariableTypeHandler;
import com.eudemon.flow.variable.service.impl.db.VariableDbSchemaManager;
import com.eudemon.flow.variable.service.types.BooleanType;
import com.eudemon.flow.variable.service.types.ByteArrayType;
import com.eudemon.flow.variable.service.types.CustomObjectType;
import com.eudemon.flow.variable.service.types.DateType;
import com.eudemon.flow.variable.service.types.DefaultVariableTypes;
import com.eudemon.flow.variable.service.types.DoubleType;
import com.eudemon.flow.variable.service.types.EntityManagerSession;
import com.eudemon.flow.variable.service.types.EntityManagerSessionFactory;
import com.eudemon.flow.variable.service.types.IntegerType;
import com.eudemon.flow.variable.service.types.JPAEntityListVariableType;
import com.eudemon.flow.variable.service.types.JPAEntityVariableType;
import com.eudemon.flow.variable.service.types.JodaDateTimeType;
import com.eudemon.flow.variable.service.types.JodaDateType;
import com.eudemon.flow.variable.service.types.JsonType;
import com.eudemon.flow.variable.service.types.LongJsonType;
import com.eudemon.flow.variable.service.types.LongStringType;
import com.eudemon.flow.variable.service.types.LongType;
import com.eudemon.flow.variable.service.types.NullType;
import com.eudemon.flow.variable.service.types.SerializableType;
import com.eudemon.flow.variable.service.types.ShortType;
import com.eudemon.flow.variable.service.types.StringType;
import com.eudemon.flow.variable.service.types.UUIDType;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration implements
    ...
    public static final String DEFAULT_WS_SYNC_FACTORY = "com.eudemon.flow.engine.impl.webservice.CxfWebServiceClientFactory";

    public static final String DEFAULT_WS_IMPORTER = "com.eudemon.flow.engine.impl.webservice.CxfWSDLImporter";
