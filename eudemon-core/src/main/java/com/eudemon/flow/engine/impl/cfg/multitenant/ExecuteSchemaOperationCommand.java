...
public class ExecuteSchemaOperationCommand implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        if (com.eudemon.flow.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_CREATE_DROP.equals(schemaOperation)
        ...
        } else if (com.eudemon.flow.engine.ProcessEngineConfiguration.DB_SCHEMA_UPDATE_FALSE.equals(schemaOperation)) {
