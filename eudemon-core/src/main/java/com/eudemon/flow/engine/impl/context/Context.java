...
package com.eudemon.flow.engine.impl.context;

import com.eudemon.flow.common.engine.impl.cfg.TransactionContext;
import com.eudemon.flow.common.engine.impl.interceptor.CommandContext;
import com.eudemon.flow.common.engine.impl.transaction.TransactionContextHolder;
 ...
 *
 * - {@link com.eudemon.flow.common.engine.impl.interceptor.CommandContext},
 * - {@link ProcessEngineConfigurationImpl}
 * - {@link com.eudemon.flow.common.engine.impl.cfg.TransactionContext}
 *
 * Note that this class is here for backwards compatibility.
 * Use the engine-independent {@link com.eudemon.flow.common.engine.impl.context.Context} and {@link CommandContextUtil} when possible.
 */
