 ...
 */
package com.eudemon.flow.task.repository;
...
public interface HistoricTaskService {
    ...
    List<HistoricTaskInstance> findHistoricTaskInstancesByQueryCriteria(HistoricTaskInstanceQuery historicTaskInstanceQuery);
