 ...
 */
package com.eudemon.flow.variable.service;
...
public interface HistoricVariableService {
    ...
    List<HistoricVariableInstance> findHistoricVariableInstancesByQueryCriteria(HistoricVariableInstanceQuery query);
