...
public interface AutoDeploymentStrategy {
    ...
    /**
     * Performs deployment for the provided resources, using the provided name as a hint and the provided {@link DmnRepositoryService} to perform deployment(s).
     *
     ...
     */
    void deployResources(final String deploymentNameHint, final Resource[] resources, final DmnRepositoryService repositoryService);
