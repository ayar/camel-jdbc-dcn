 ...
 */
package com.eudemon.flow.app.engine;
...
import com.eudemon.flow.common.engine.api.EngineInfo;
...
public abstract class AppEngines {
    ...
    protected static void initAppEngineFromSpringResource(URL resource) {
        try {
            Class<?> springConfigurationHelperClass = ReflectUtil.loadClass("com.eudemon.flow.app.spring.SpringAppConfigurationHelper");
