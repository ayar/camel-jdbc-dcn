...
package com.eudemon.flow.form.spring.autodeployment;
...
public interface AutoDeploymentStrategy {
     ...
     */
    void deployResources(final String deploymentNameHint, final Resource[] resources, final FormRepositoryService repositoryService);
