 ...
 */
package com.eudemon.flow.cmmn.spring.impl.test;
...
public abstract class SpringFlowableTestCase extends TestCase implements ApplicationContextAware {

    // we need a data structure to store all the resolved FormEngines and map them to something
    protected Map<Object, CmmnEngine> cachedCmmnEngines = new ConcurrentHashMap<>();
