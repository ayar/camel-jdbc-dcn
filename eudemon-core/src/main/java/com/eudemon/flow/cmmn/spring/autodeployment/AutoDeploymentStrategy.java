...
package com.eudemon.flow.cmmn.spring.autodeployment;
...
public interface AutoDeploymentStrategy {
    ...
    /**
     * Performs deployment for the provided resources, using the provided name as a hint and the provided {@link CmmnRepositoryService} to perform deployment(s).
     *
     ...
     */
    void deployResources(final String deploymentNameHint, final Resource[] resources, final CmmnRepositoryService repositoryService);
